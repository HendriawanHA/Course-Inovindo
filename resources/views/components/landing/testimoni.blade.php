<section id="testimonials"
    ...
    class="bg-white dark:bg-zinc-900 py-24 overflow-hidden relative">
    <x-landing.dark-bg />
    <div class="text-center mb-14">
        ...
        <div class="flex items-center justify-center gap-6 mb-5">
            ...
            <div class="flex items-center gap-2">
                ...
                <svg
                    ...
                    class="w-8 h-8 md:w-12 md:h-12 text-blue-700"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2.2">
                ...
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-6 h-6 md:w-10 md:h-10 text-emerald-500 translate-y-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2.2">
        ...
        text-zinc-900 dark:text-white px-6">
        ...
        <div class="testimonial-track flex gap-8">
            ...
            <template
                ...
                <x-landing.card-wrapper>
                    ...
                    <flux:card
                        class=" w-[300px] md:w-[380px] h-[360px] shrink-0 flex flex-col items-center text-center p-8 bg-white dark:bg-zinc-900/95 border border-zinc-200 dark:border-zinc-700 backdrop-blur-md transition-all duration-300
                hover:-translate-y-2">
                        <img
                            :src="'https://ui-avatars.com/api/?name=' + encodeURIComponent(item.name)"
                            class="w-16 h-16 rounded-full object-cover ring-2 ring-zinc-200 dark:ring-zinc-700">

                        <h3
                            class="mt-5 text-lg font-semibold text-zinc-900 dark:text-white"
                            x-text="item.name">
                        </h3>

                        <p
                            class="text-sm text-blue-600 mt-1 dark:text-blue-400"
                            x-text="item.role">
                        </p>
