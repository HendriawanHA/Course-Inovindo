<flux:card
    class="w-full lg:w-96 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 md:p-6 h-fit">
    <div class="flex items-center gap-4">
        ...
        <div>
            <flux:heading level="3" class="font-semibold break-words text-zinc-900 dark:text-white">
