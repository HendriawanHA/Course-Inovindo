    ...
    <div x-data="{ sidebarOpen: window.innerWidth >= 1024 }" class="flex flex-1">
        ...
        : 'text-zinc-500 dark:text-zinc-400'" />
            ...
            <div class="max-w-4xl mx-auto w-full px-6 mt-8">
                ...
                <div id="discussion-section" x-data="{
                    replyingTo: null,
                    replyingName: null,
                    replyUrl: null,
                    ...
                    <div class="divide-y divide-zinc-200 dark:divide-zinc-800">
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <button @click="setReply({{ $discussion->id }}, '{{ $discussion->user->name }}', '{{ route('discussions.reply', $discussion->id) }}')"
                                        ...
                                        @if ($discussion->replies->count())
                                            <div
                                                class="mt-5 space-y-4 border-l-2 border-zinc-200 dark:border-zinc-800 pl-4">
                                                ...
                                                @foreach ($discussion->replies as $reply)
                                                    <div class="flex gap-3">
                                                        ...
                                                        <div
                                                            class="flex-1 rounded-2xl bg-zinc-50 dark:bg-zinc-800/60 px-4 py-3">
                                                            ...
                                                            <p
                                                                class="mt-1 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                                                                {{ $reply->content }}
                                                            </p>
                        ...
                        @empty
                            ...
                            <div class="flex flex-col items-center justify-center text-center px-8 py-14">
                                <div
                                    class="w-16 h-16 rounded-2xl bg-indigo-500/10 flex items-center justify-center mb-5">
                    ...
                    <form method="POST" x-bind:action="replyUrl ?? '{{ route('discussions.store') }}'"
                        ...
                        <div class="flex items-end gap-3">
                            ...
                            <textarea x-ref="commentInput" name="content" rows="1" required placeholder="Write a comment..."
